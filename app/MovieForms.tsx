...
const MovieForms = () => {
  ...
  return (
    <div className="row">
      <form style={{ width: 800}} className='gradient-custom bg-info mx-20' onSubmit={simpanData}>
        ...
        <div className="form-group row">
          <label htmlFor="foto" className="col-sm-2 col-form-label">Gambar Cover</label>
          <div className="col-sm-10">

            <input type="file" className="form-control-file" id="foto" ref={fileInputRef}
